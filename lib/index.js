...
exports.Engine = class CatboxMemoryEngine {
    ...
    stop() {
        ...
        this.cache = null;
        this.byteSize = 0;
        this.currentItemCount = 0;  // Reset item count on stop
    }
    ...
    get(key) {
        ...
        if (!segment) {
            this.cacheMisses++;  // Increment cache miss
            return null;
        }
        ...
        this.cacheHits++;  // Increment cache hit
        return {
            item,
    ...
    set(key, value, ttl) {
        ...
        if (cachedItem) {
            ...
            this.currentItemCount--;  // Decrement item count if replacing
        }
        ...
        this.byteSize += envelope.byteSize;
        this.currentItemCount++;  // Increment item count
    }
    ...
    drop(key) {
        ...
        if (segment) {
            ...
            if (item) {
                ...
                this.currentItemCount--;  // Decrement item count on drop
            }
        }
    }

    // New method to retrieve cache statistics
    getStats() {

        return {
            cacheHits: this.cacheHits,
            cacheMisses: this.cacheMisses,
            currentByteSize: this.byteSize,
